...
partial class Build
{
    ...
    .Executes(() =>
    {
        var aipProjectPath = Path.Combine(RootDirectory, @"Installer\IsolateWarnings.aip");
        var version = Solution.IsolateWarnings.GetProperty("Version");
    ...
    {
        var aipOutputPath = Path.Combine(RootDirectory, @"Installer\IsolateWarnings-SetupFiles");
